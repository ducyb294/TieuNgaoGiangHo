...
const TEXT = {
  ...
  casinoClaimed: "Bạn đã nhận role Chủ Sòng Bài.",
  casinoReleased: "Đã hủy role Chủ Sòng Bài.",
  casinoBelowMin: "Ngân lượng chưa đủ để nhận role.",
  casinoMaxSet: "Đã cập nhật cược tối đa chẵn lẻ.",
  casinoMinSet: "Đã cập nhật tài sản tối thiểu để nhận role.",
  casinoExpired: "Thời gian Chủ Sòng Bài đã hết, role được trả lại.",
  casinoBankrupt: "Chủ Sòng Bài đã phá sản, role được trả lại.",
...
const CASINO_OWNER_DURATION_MS = 12 * 60 * 60 * 1000;
